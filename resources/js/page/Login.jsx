...
export default function Login() {
  ...
  const isValidEmail = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(form.login.trim());
  ...
  const validate = () => {
    ...
    if (!form.login.trim()) nextErrors.login = "Email or phone is required";
      ...
      <div className="login-card">
        <div className="login-left">
          ...
          <form className="login-form" onSubmit={handleSubmit} noValidate>
            <div className={`login-field ${errors.login ? "has-error" : ""}`}>
              ...
              />
              {isValidEmail ? <FaCheckCircle className="login-field-check" /> : null}
            </div>
