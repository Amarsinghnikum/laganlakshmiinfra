...
@section("title","lagan lakshmi infra | property detail")
                        ...
                        <nav class="nav-menu">
                            <ul>
                                ...
                                <li class="active"><a href="#">Properties</a>
                                    <ul class="dropdown">
                                        <li><a href="{{route('properties')}}">Property Grid</a></li>
                                        <li><a href="{{route('properties')}}">Property List</a></li>
                                        <li><a href="{{route('property.details')}}">Property Detail</a></li>
                                        <li><a href="{{route('properties')}}">Property Comparison</a></li>
                                        <li><a href="{{route('user.properties.create')}}">Property Submit</a></li>
                                    </ul>
                                </li>
                                        ...
                                        <div class="tab-details">
                                            <ul class="left-table">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="type-value"><button class="btn"><a
                                                                href="{{url('contact-us')}}" class="contact-btn">contact
                                                                us</a></button></span>
                                                </li>
                                                <li>
                                    ...
                                    <div class="tab-pane" id="tabs-2" role="tabpanel">
                                        <div class="tab-desc">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt dolor
                                                itaque facere consequatur, dignissimos minus adipisci ipsam repudiandae
                                                nisi illum provident, natus quidem vero? Quaerat ducimus sequi
                                                praesentium commodi, consectetur corporis eos sit perspiciatis, quae sed
                                                officia error, iure quasi.</p>
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt dolor
                                                itaque facere consequatur, dignissimos minus adipisci ipsam repudiandae
                                                nisi illum provident, natus quidem vero? Quaerat ducimus sequi
                                                praesentium commodi, consectetur corporis eos sit perspiciatis, quae sed
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="ml-item">
                                            ...
                                            <div class="ml-single-item">
                                                <h6>Schools <span>( <i class="fa fa-location-arrow"></i> 8 km )</span>
                                                </h6>
                                                <p>Cragin Elementary School</p>
                                            </div>
                                            <div class="ml-single-item">
                                                <h6>Store <span>( <i class="fa fa-location-arrow"></i> 2 km )</span>
                                                </h6>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="ml-item">
                                            <div class="ml-single-item">
                                                <h6>Laundry <span>( <i class="fa fa-location-arrow"></i> 3 km )</span>
                                                </h6>
                                                <p>Besst at laundry</p>
                                            </div>
                                            <div class="ml-single-item">
                                                <h6>Health <span>( <i class="fa fa-location-arrow"></i> 5 km )</span>
                                                </h6>
