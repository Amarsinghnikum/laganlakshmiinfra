...
@section("title","lagan lakshmi infra |index page")
...
<section class="hero-section">
    <div class="container">
        <div class="hs-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="{{url('/assets/img/hero/hero-1.jpg')}}">
                <div class="row">
                    <div class="col-lg-12">
...
<section class="chooseus-section spad set-bg" data-setbg="{{url('/assets/img/chooseus/chooseus-bg.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="chooseus-text">
                    ...
                    <p>
                        We are committed to making your property journey simple and transparent.
                        With local expertise, verified listings, and personalized support,
                        we help you make confident decisions—whether you're buying, renting, or selling.
                    </p>
                </div>
                ...
                <div class="chooseus-features">
                    <div class="cf-item">
                        ...
                        <div class="cf-text">
                            ...
                            <p>
                                Discover homes that truly match your lifestyle, budget, and long-term goals.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="cf-item">
                        ...
                        <div class="cf-text">
                            <h5>Buy or Rent with Confidence</h5>
                            <p>
                                Access verified properties for sale or rent in prime and emerging locations.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="cf-item">
                        ...
                        <div class="cf-text">
                            <h5>Trusted & Experienced Agents</h5>
                            <p>
                                Work with professionals who understand the local market and your needs.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="cf-item">
                        ...
                        <div class="cf-text">
                            <h5>List Your Property Easily</h5>
                            <p>
                                List your property with ease and reach genuine buyers or tenants faster.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="lc-slider owl-carousel">
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="{{url('/assets/img/logo-carousel/lc-1.png')}}" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="{{url('/assets/img/logo-carousel/lc-2.png')}}" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="{{url('/assets/img/logo-carousel/lc-3.png')}}" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="{{url('/assets/img/logo-carousel/lc-4.png')}}" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="{{url('/assets/img/logo-carousel/lc-5.png')}}" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="{{url('/assets/img/logo-carousel/lc-6.png')}}" alt="">
                </div>
            </a>
        </div>
    </div>
