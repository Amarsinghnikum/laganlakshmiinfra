...
@section("title","lagan lakshmi infra | property submit")
                    ...
                    <form action="#">
                        ...
                        <div class="pf-summernote">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link texteditor-switch" data-toggle="tab" href="#tabs-1"
                                        role="tab">Text</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link texteditor-switch active" data-toggle="tab" href="#tabs-2"
                                        role="tab">Visual</a>
                                </li>
                            </ul>
                                ...
                                <div class="col-lg-8">
                                    <div class="g-map">
                                        <iframe
                                            ...
                                            height="245" style="border:0;" allowfullscreen=""></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
