...
const Signin = () => {
  ...
  const isValidEmail = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.login.trim());
    ...
    <div className="signin-container">
      <div className="signin-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={`input-group ${isValidEmail ? "has-status-icon" : ""}`}>
            <input
              type="text"
              name="login"
              ...
              required
            />
            {isValidEmail ? <FaCheckCircle className="input-status-icon" /> : null}
          </div>
